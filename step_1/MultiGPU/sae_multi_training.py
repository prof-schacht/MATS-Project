...
def phi3_sae_runner_multiple_devices():

    cfg_dict = BASE_CFG
    cfg_dict["model_name"] = "microsoft/Phi-3-mini-4k-instruct"
    cfg_dict['dataset_path'] = "mlfoundations/dclm-baseline-1.0"
    cfg_dict['hook_name'] = "blocks.16.hook_resid_post"
    cfg_dict['hook_layer'] = 16
    cfg_dict['d_in'] = 3072
    cfg_dict['train_batch_size_tokens'] = batch_size
    cfg_dict['is_dataset_tokenized'] = False
    ...
    cfg_dict['context_size'] = 2048
    cfg_dict['wandb_project']="phi3-mini-sae"
    cfg_dict['wandb_log_frequency'] = 30
    cfg_dict['expansion_factor'] = 32
...
#test_sae_runner_multiple_devices()
#test_sae_runner_multiple_devices_sae_act_store_on_gpus()
phi3_sae_runner_multiple_devices()